...
news_emb_df = pd.read_csv('/var/scratch/zta207/experiments/mind_small_CL_2/news_final_emb.csv')
before = pd.read_csv('/var/scratch/zta207/experiments/mind_small_CL_emb_07_05/before_cl_user_emb.csv')
after = pd.read_csv('/var/scratch/zta207/experiments/mind_small_CL_emb_07_05/after_cl_user_emb.csv')
...
# news vs. before plot
polar_out_path1 = os.path.join(out_dir, 'polar_news_vs_before2.png')
plot_polar(
    data1=before_polar, 
    data2=news_polar,
...
# news vs. after plot
polar_out_path2 = os.path.join(out_dir, 'polar_news_vs_after2.png')
plot_polar(
    data1=after_polar2, 
    data2=news_polar2,
